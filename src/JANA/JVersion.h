// $Id: JVersion.h 2481 2017-11-22 13:13:42Z davidl $
//
//    File: JVersion.h
...
class JVersion{
	public:
		...
		static string GetIDstring(void){return "$Id: JVersion.h 2481 2017-11-22 13:13:42Z davidl $";}
		static string GetSVNrevision(void){return ExtractContent("$Revision: 2481 $");}
		static string GetDate(void){return ExtractContent("$Date: 2017-11-22 08:13:42 -0500 (Wed, 22 Nov 2017) $");}
		static string GetURL(void){return ExtractContent("$URL: https://phys12svn.jlab.org/repos/tags/jana_0.7.9p1/src/JANA/JVersion.h $");}
